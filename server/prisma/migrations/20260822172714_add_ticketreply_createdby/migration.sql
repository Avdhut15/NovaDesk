...
*/
-- DropForeignKey
ALTER TABLE "tickets" DROP CONSTRAINT "tickets_assignedAgentId_fkey";

-- DropForeignKey
ALTER TABLE "tickets" DROP CONSTRAINT "tickets_createdById_fkey";

-- AlterTable
ALTER TABLE "ticket_replies" ADD COLUMN     "createdById" TEXT;
...
-- AddForeignKey
ALTER TABLE "ticket_replies" ADD CONSTRAINT "ticket_replies_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES "user"("id") ON DELETE SET NULL ON UPDATE CASCADE;
